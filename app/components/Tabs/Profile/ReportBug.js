/*
*
*    Prikazuje ekran za prijavu greške
*
*/
...
import { reportBug } from '../../../actions/report';
...
const errorSelector = createErrorMessageSelector( [ 'REPORT_BUG' ] );
const successSelector = createSuccessMessageSelector( [ 'REPORT_BUG' ] );
...
const ReportBug = ( props ) => {
    ...
    const handleSave = ( ) => {
        props.resetErrors( );
        props.reportBug( bug, props.token );
    }
    ...
    return  <>
                ...
                <ScrollView contentContainerStyle={ { flex: 1, alignItems: "center", justifyContent: "flex-start" }  }>
                    <View style={ styles.inputContainer }>
                        <Text style={ styles.inputLabel }>Opis greške</Text>
                        <TextInput placeholder="Unesite opis greske" multiline={ true } numberOfLines={ 12 } value={ bug } onChangeText={ setBug } style={ { ...styles.input, textAlignVertical: "top" } } />
